...
test.describe('Fase 4 — Home Reconstruction Attention-First E2E Suite (/dashboard)', () => {
  ...
  test('01. /dashboard renders Attention-First 4-Layer Structure', async ({ page }) => {
    ...
    await expect(page.locator('main a[href="/dashboard/aktivitas"]').first()).toBeVisible();
    await expect(page.locator('main a[href="/dashboard/aid-requests"]').first()).toBeVisible();
