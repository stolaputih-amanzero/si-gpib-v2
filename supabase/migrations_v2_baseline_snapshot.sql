...
DROP POLICY IF EXISTS policy_pos_select_t_log_pastoral ON t_log_pastoral;
...
DROP POLICY IF EXISTS policy_pos_insert_t_log_pastoral ON t_log_pastoral;
CREATE POLICY policy_pos_insert_t_log_pastoral ON t_log_pastoral FOR INSERT WITH CHECK (id_pos = get_active_context_id());
DROP POLICY IF EXISTS policy_pos_update_t_log_pastoral ON t_log_pastoral;
...
DROP POLICY IF EXISTS policy_pos_delete_t_log_pastoral ON t_log_pastoral;
...
DROP POLICY IF EXISTS policy_pos_select_t_jadwal_ibadah ON t_jadwal_ibadah;
...
DROP POLICY IF EXISTS policy_pos_insert_t_jadwal_ibadah ON t_jadwal_ibadah;
CREATE POLICY policy_pos_insert_t_jadwal_ibadah ON t_jadwal_ibadah FOR INSERT WITH CHECK (id_pos = get_active_context_id());
DROP POLICY IF EXISTS policy_pos_update_t_jadwal_ibadah ON t_jadwal_ibadah;
...
DROP POLICY IF EXISTS policy_pos_delete_t_jadwal_ibadah ON t_jadwal_ibadah;
...
DROP POLICY IF EXISTS policy_pos_select_t_aset_tanah ON t_aset_tanah;
...
DROP POLICY IF EXISTS policy_pos_insert_t_aset_tanah ON t_aset_tanah;
CREATE POLICY policy_pos_insert_t_aset_tanah ON t_aset_tanah FOR INSERT WITH CHECK (id_pos = get_active_context_id());
DROP POLICY IF EXISTS policy_pos_update_t_aset_tanah ON t_aset_tanah;
...
DROP POLICY IF EXISTS policy_pos_delete_t_aset_tanah ON t_aset_tanah;
...
DROP POLICY IF EXISTS policy_pos_select_t_aset_bangunan ON t_aset_bangunan;
...
DROP POLICY IF EXISTS policy_pos_insert_t_aset_bangunan ON t_aset_bangunan;
CREATE POLICY policy_pos_insert_t_aset_bangunan ON t_aset_bangunan FOR INSERT WITH CHECK (id_pos = get_active_context_id());
DROP POLICY IF EXISTS policy_pos_update_t_aset_bangunan ON t_aset_bangunan;
...
DROP POLICY IF EXISTS policy_pos_delete_t_aset_bangunan ON t_aset_bangunan;
...
DROP POLICY IF EXISTS policy_pos_select_t_aset_bergerak ON t_aset_bergerak;
...
DROP POLICY IF EXISTS policy_pos_insert_t_aset_bergerak ON t_aset_bergerak;
CREATE POLICY policy_pos_insert_t_aset_bergerak ON t_aset_bergerak FOR INSERT WITH CHECK (id_pos = get_active_context_id());
DROP POLICY IF EXISTS policy_pos_update_t_aset_bergerak ON t_aset_bergerak;
...
DROP POLICY IF EXISTS policy_pos_delete_t_aset_bergerak ON t_aset_bergerak;
...
DROP POLICY IF EXISTS policy_pos_select_t_pengajuan_bantuan ON t_pengajuan_bantuan;
...
DROP POLICY IF EXISTS policy_pos_insert_t_pengajuan_bantuan ON t_pengajuan_bantuan;
...
DROP POLICY IF EXISTS policy_pos_update_t_pengajuan_bantuan ON t_pengajuan_bantuan;
...
DROP POLICY IF EXISTS policy_pos_delete_t_pengajuan_bantuan ON t_pengajuan_bantuan;
...
DROP POLICY IF EXISTS policy_pos_select_t_demografi_pelkat ON t_demografi_pelkat;
...
DROP POLICY IF EXISTS policy_pos_insert_t_demografi_pelkat ON t_demografi_pelkat;
...
DROP POLICY IF EXISTS policy_pos_update_t_demografi_pelkat ON t_demografi_pelkat;
...
DROP POLICY IF EXISTS policy_pos_delete_t_demografi_pelkat ON t_demografi_pelkat;
...
DROP POLICY IF EXISTS policy_pos_select_t_kerawanan_wilayah ON t_kerawanan_wilayah;
...
DROP POLICY IF EXISTS policy_pos_insert_t_kerawanan_wilayah ON t_kerawanan_wilayah;
...
DROP POLICY IF EXISTS policy_pos_update_t_kerawanan_wilayah ON t_kerawanan_wilayah;
...
DROP POLICY IF EXISTS policy_pos_delete_t_kerawanan_wilayah ON t_kerawanan_wilayah;
...
DROP POLICY IF EXISTS policy_pos_select_t_potensi_wilayah ON t_potensi_wilayah;
...
DROP POLICY IF EXISTS policy_pos_insert_t_potensi_wilayah ON t_potensi_wilayah;
...
DROP POLICY IF EXISTS policy_pos_update_t_potensi_wilayah ON t_potensi_wilayah;
...
DROP POLICY IF EXISTS policy_pos_delete_t_potensi_wilayah ON t_potensi_wilayah;
...
DROP POLICY IF EXISTS policy_pos_delete_t_pelayan ON t_pelayan;
...
DROP POLICY IF EXISTS policy_pos_delete_t_relawan ON t_relawan;
...
DROP POLICY IF EXISTS policy_select_t_lampiran_aset ON t_lampiran_aset;
...
DROP POLICY IF EXISTS policy_insert_t_lampiran_aset ON t_lampiran_aset;
...
DROP POLICY IF EXISTS policy_update_t_lampiran_aset ON t_lampiran_aset;
...
DROP POLICY IF EXISTS policy_delete_t_lampiran_aset ON t_lampiran_aset;
...
DROP POLICY IF EXISTS policy_select_t_lampiran_kerawanan ON t_lampiran_kerawanan;
...
DROP POLICY IF EXISTS policy_insert_t_lampiran_kerawanan ON t_lampiran_kerawanan;
...
DROP POLICY IF EXISTS policy_update_t_lampiran_kerawanan ON t_lampiran_kerawanan;
...
DROP POLICY IF EXISTS policy_delete_t_lampiran_kerawanan ON t_lampiran_kerawanan;
...
DROP POLICY IF EXISTS policy_select_t_lampiran_potensi ON t_lampiran_potensi;
...
DROP POLICY IF EXISTS policy_insert_t_lampiran_potensi ON t_lampiran_potensi;
...
DROP POLICY IF EXISTS policy_update_t_lampiran_potensi ON t_lampiran_potensi;
...
DROP POLICY IF EXISTS policy_delete_t_lampiran_potensi ON t_lampiran_potensi;
...
DROP POLICY IF EXISTS policy_jem_select_m_jemaat_induk ON m_jemaat_induk;
...
DROP POLICY IF EXISTS policy_jem_insert_m_jemaat_induk ON m_jemaat_induk;
CREATE POLICY policy_jem_insert_m_jemaat_induk ON m_jemaat_induk FOR INSERT WITH CHECK (id_induk = get_active_context_id());
DROP POLICY IF EXISTS policy_jem_update_m_jemaat_induk ON m_jemaat_induk;
...
DROP POLICY IF EXISTS policy_jem_delete_m_jemaat_induk ON m_jemaat_induk;
...
DROP POLICY IF EXISTS policy_jem_select_t_pj_jemaat ON t_pj_jemaat;
...
DROP POLICY IF EXISTS policy_jem_insert_t_pj_jemaat ON t_pj_jemaat;
CREATE POLICY policy_jem_insert_t_pj_jemaat ON t_pj_jemaat FOR INSERT WITH CHECK (id_induk = get_active_context_id());
DROP POLICY IF EXISTS policy_jem_update_t_pj_jemaat ON t_pj_jemaat;
...
DROP POLICY IF EXISTS policy_jem_delete_t_pj_jemaat ON t_pj_jemaat;
...
DROP POLICY IF EXISTS policy_jem_select_t_penugasan_pendeta ON t_penugasan_pendeta;
...
DROP POLICY IF EXISTS policy_jem_insert_t_penugasan_pendeta ON t_penugasan_pendeta;
...
DROP POLICY IF EXISTS policy_jem_update_t_penugasan_pendeta ON t_penugasan_pendeta;
...
DROP POLICY IF EXISTS policy_jem_delete_t_penugasan_pendeta ON t_penugasan_pendeta;
...
DROP POLICY IF EXISTS policy_jem_select_t_histori_perubahan_status ON t_histori_perubahan_status;
...
DROP POLICY IF EXISTS policy_jem_insert_t_histori_perubahan_status ON t_histori_perubahan_status;
...
DROP POLICY IF EXISTS policy_jem_update_t_histori_perubahan_status ON t_histori_perubahan_status;
...
DROP POLICY IF EXISTS policy_jem_delete_t_histori_perubahan_status ON t_histori_perubahan_status;
...
DROP POLICY IF EXISTS policy_self_users ON users;
...
DROP POLICY IF EXISTS policy_self_m_push_subscription ON m_push_subscription;
...
DROP POLICY IF EXISTS policy_self_webauthn_challenges ON webauthn_challenges;
...
DROP POLICY IF EXISTS policy_person_select_m_pendeta ON m_pendeta;
...
DROP POLICY IF EXISTS policy_person_update_m_pendeta ON m_pendeta;
...
DROP POLICY IF EXISTS policy_person_select_t_jabatan_struktural ON t_jabatan_struktural;
...
DROP POLICY IF EXISTS policy_person_update_t_jabatan_struktural ON t_jabatan_struktural;
...
DROP POLICY IF EXISTS policy_person_select_t_keterlibatan_pendeta ON t_keterlibatan_pendeta;
...
DROP POLICY IF EXISTS policy_person_update_t_keterlibatan_pendeta ON t_keterlibatan_pendeta;
...
DROP POLICY IF EXISTS policy_privacy_t_keluarga_pendeta ON t_keluarga_pendeta;
...
DROP POLICY IF EXISTS policy_privacy_m_webauthn_credentials ON m_webauthn_credentials;
...
DROP POLICY IF EXISTS policy_sys_select_t_log_aktivitas ON t_log_aktivitas;
...
DROP POLICY IF EXISTS policy_sys_insert_t_log_aktivitas ON t_log_aktivitas;
CREATE POLICY policy_sys_insert_t_log_aktivitas ON t_log_aktivitas FOR INSERT WITH CHECK (has_global_scope());
DROP POLICY IF EXISTS policy_sys_update_t_log_aktivitas ON t_log_aktivitas;
...
DROP POLICY IF EXISTS policy_sys_select_t_approval_bantuan ON t_approval_bantuan;
...
DROP POLICY IF EXISTS policy_sys_insert_t_approval_bantuan ON t_approval_bantuan;
CREATE POLICY policy_sys_insert_t_approval_bantuan ON t_approval_bantuan FOR INSERT WITH CHECK (has_global_scope());
DROP POLICY IF EXISTS policy_sys_update_t_approval_bantuan ON t_approval_bantuan;
...
DROP POLICY IF EXISTS policy_sys_select_t_riwayat_mutasi_pendeta ON t_riwayat_mutasi_pendeta;
...
DROP POLICY IF EXISTS policy_sys_insert_t_riwayat_mutasi_pendeta ON t_riwayat_mutasi_pendeta;
...
DROP POLICY IF EXISTS policy_sys_update_t_riwayat_mutasi_pendeta ON t_riwayat_mutasi_pendeta;
...
DROP POLICY IF EXISTS policy_sys_all_sys_transaction_logs ON sys_transaction_logs;
...
DROP POLICY IF EXISTS policy_sys_all_sys_telemetry ON sys_telemetry;
...
-- 1. Master Tables
CREATE TABLE IF NOT EXISTS m_mupel (
...
CREATE TABLE IF NOT EXISTS m_jemaat_induk (
...
CREATE TABLE IF NOT EXISTS m_pos_pelkes (
...
CREATE TABLE IF NOT EXISTS m_pendeta (
...
ALTER TABLE m_jemaat_induk DROP CONSTRAINT IF EXISTS fk_jemaat_kmj;
