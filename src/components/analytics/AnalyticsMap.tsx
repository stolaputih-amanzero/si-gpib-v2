...
export function AnalyticsMap({ locations }: AnalyticsMapProps) {
  return (
    <div className="bg-surface-elevated rounded-2xl border border-border-subtle p-4 md:p-6 shadow-sm space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-base font-bold text-text-high flex items-center gap-2">
