...
export function DemografiCard({ 
  ...
  const content = (
    <div 
      onClick={onClick}
      className="bg-surface-elevated rounded-xl p-4 shadow-soft border border-border-subtle hover:border-brand-primary/30 transition-all active:scale-[0.99] space-y-3 cursor-pointer group"
    >
