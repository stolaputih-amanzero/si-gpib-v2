  ...
  return (
    <>
      <div 
        ...
        onClick={onClose}
      />
      <div className="fixed bottom-0 left-0 right-0 z-[1001] bg-surface-elevated rounded-t-3xl shadow-xl border-t border-border-subtle animate-in slide-in-from-bottom-full pb-safe max-h-[85vh] overflow-y-auto">
        <div className="p-4">
          {/* Drag Handle */}
          ...
          <div className="flex justify-between items-start mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-text-high text-lg leading-tight line-clamp-2">
                  {point.title}
                </h3>
            ...
            <button 
              onClick={onClose}
              className="p-2 rounded-full bg-surface-sunken hover:bg-surface-elevated text-text-muted transition-colors shrink-0"
            >
              <X size={20} />
            </button>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-3 bg-surface-sunken rounded-xl border border-border-subtle flex items-center justify-between">
              <span className="text-sm font-medium text-text-muted">Kategori Titik</span>
