...
import { 
  ShieldAlert, Search, Filter, Trash2, X, AlertTriangle, Building2, 
  Calendar, Share2, Edit2, MapPin, Clock, UserCheck, Image as ImageIcon, ExternalLink 
} from 'lucide-react';
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs text-text-muted">
                    ...
                    {photoCount > 0 && (
                      <span className="inline-flex items-center gap-1 text-[11px] font-bold text-amber-600 bg-amber-500/10 px-2 py-0.5 rounded-full shrink-0">
                        <ImageIcon size={12} />
          ...
          <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto bg-surface-elevated rounded-3xl shadow-heavy border border-border-subtle relative animate-slide-up flex flex-col">
            ...
            <div className="p-4 sm:p-5 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-surface-sunken border border-border-subtle">
                <span className="text-xs font-semibold text-text-muted">Tingkat Frekuensi Kerawanan</span>
                {getFrekuensiBadge(selectedDetail.frekuensi)}
              </div>
              ...
              {selectedDetail.keterangan && (
                <div className="space-y-1.5">
                  <h4 className="text-xs font-bold text-text-high uppercase tracking-wider">Keterangan & Langkah Mitigasi</h4>
            ...
            <div className="p-4 border-t border-border-subtle bg-surface-sunken/40 flex items-center gap-2">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  handleDeleteKerawanan(item.id_risiko);
                }}
